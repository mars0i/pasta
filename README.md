...
<tr><td valign=top>KMaxMap:</td> <td>Comma-separated times and target subpop sizes to cull k-snipes to, e.g. "time,size,time,size"</td></tr>
<tr><td valign=top>RMaxMap:</td> <td>Comma-separated times and target subpop sizes to cull r-snipes to, e.g. "time,size,time,size"</td></tr>
<tr><td valign=top>SMaxMap:</td> <td>Comma-separated times and target subpop sizes to cull s-snipes to, e.g. "time,size,time,size"</td></tr>
<tr><td valign=top>KMinMap:</td> <td>Comma-separated times and target subpop sizes to increase k-snipes to, e.g. "time,size,time,size"</td></tr>
<tr><td valign=top>RMinMap:</td> <td>Comma-separated times and target subpop sizes to increase r-snipes to, e.g. "time,size,time,size"</td></tr>
<tr><td valign=top>SMinMap:</td> <td>Comma-separated times and target subpop sizes to increase s-snipes to, e.g. "time,size,time,size"</td></tr>
</table>
