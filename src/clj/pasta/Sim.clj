...
(defsim/defsim [[num-k-snipes       25      long    [0 500]     ["-K" "Size of k-snipe subpopulation" :parse-fn #(Long. %)]]
		...
		[k-cull-map         nil IPersistentMap false    ["-k" "Comma-separated sequence of times and target subpop sizes to cull k-snipes to, e.g.  \"100,200,100,400\"" :parse-fn string-to-map]]
		[r-cull-map         nil IPersistentMap false    ["-r" "Comma-separated sequence of times and target subpop sizes to cull r-snipes to, e.g.  \"100,200,100,400\"" :parse-fn string-to-map]]
		[s-cull-map         nil IPersistentMap false    ["-s" "Comma-separated sequence of times and target subpop sizes to cull s-snipes to, e.g.  \"100,200,100,400\"" :parse-fn string-to-map]]
