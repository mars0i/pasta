...
(do
 (clojure.core/ns free-agent.SimConfigData)
 ...
 (clojure.core/require '[free-agent.SimConfigData])
 (clojure.core/import free-agent.SimConfigData free-agent.SimConfig)
 (clojure.core/defn
  -init-sim-config-data
  [seed]
  [[seed]
   (clojure.core/atom
    (free-agent.SimConfigData.
     200
     200
     10.0
     10.0
 ...
 (defn
  -getInitialEnergy
  [this]
  (:initial-energy @(.simConfigData this)))
 (defn -getKSnipePrior [this] (:k-snipe-prior @(.simConfigData this)))
 (defn
  -getRSnipePrior0
  [this]
  (:r-snipe-prior-0 @(.simConfigData this)))
 (defn
  -getRSnipePrior1
  [this]
  (:r-snipe-prior-1 @(.simConfigData this)))
 ...
 (defn
  -getMushroomMean0
  [this]
  (:mushroom-mean-0 @(.simConfigData this)))
 (defn
  -getMushroomMean1
  [this]
  (:mushroom-mean-1 @(.simConfigData this)))
